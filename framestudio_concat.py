...
class ConcatTUI:
    def __init__(
        ...
        stdscr: Any,
        root: Path,
        title: str = "| FRAMESTUDIO CONCAT + FPS // SELECT INPUT VIDEOS",
    ):
        self.stdscr = stdscr
...
if __name__ == "__main__":
    sys.modules.setdefault("framestudio_concat", sys.modules[__name__])
    try:
