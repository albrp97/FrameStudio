...
Given one opened source, the user can split at a selected
playhead position, mark unwanted segments for deletion, and see the edited
duration update without changing the original media.
...
- Copy/paste, segment movement, reusable modifications, or advanced effects.
