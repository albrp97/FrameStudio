...
**Path history:** `features/open/FEAT-001-opening-a-supported-source-as-a-non-destructive-project.md`
-> `features/closed/FEAT-001-opening-a-supported-source-as-a-non-destructive-project.md`
**Horizon:** first
