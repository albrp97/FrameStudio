...
`resolve_editor/app.py`, `resolve_editor/playback.py`, and the user-reported
Space playback failure
**Dependencies:** TICKET-003 and TICKET-004; existing FFmpeg playback backend
**Risks:** keyboard focus, duplicate toggles, stale transport state, and
backend failures being presented as successful playback
