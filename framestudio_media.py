#!/usr/bin/env python3
"""FrameStudio media preparation: fast, editor-compatible media handling."""
...
FAST_VIDEO_SUFFIX = ".framestudio-ready.mxf"
FAST_AUDIO_SUFFIX = ".framestudio-ready.mkv"
LOSSLESS_SUFFIX = ".framestudio-lossless.mkv"
GENERATED_SUFFIX = FAST_VIDEO_SUFFIX
LEGACY_FAST_VIDEO_SUFFIX = ".resolve-ready.mxf"
LEGACY_FAST_AUDIO_SUFFIX = ".resolve-ready.mkv"
LEGACY_LOSSLESS_SUFFIX = ".resolve-lossless.mkv"
GENERATED_SUFFIXES = (
    FAST_VIDEO_SUFFIX,
    FAST_AUDIO_SUFFIX,
    LOSSLESS_SUFFIX,
    LEGACY_FAST_VIDEO_SUFFIX,
    LEGACY_FAST_AUDIO_SUFFIX,
    LEGACY_LOSSLESS_SUFFIX,
)
VIDEO_SAFE = {
    "ffv1",
    "dnxhd",
...
class FrameStudioTUI:
    ...
    def draw(self) -> None:
        ...
        self.stdscr.addnstr(
            1,
            0,
            f"| FRAMESTUDIO MEDIA // EVA-01 INGEST // {self.profile.upper()}",
            width - 1,
...
# Preserve the legacy class name for callers importing the old media module.
ResolveTUI = FrameStudioTUI
